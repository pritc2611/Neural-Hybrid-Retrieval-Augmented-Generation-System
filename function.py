...
# import os
# from rag_app import CPineconeHybridRetriever
...
#         # Redis
#         redis_client = redis.Redis(host="6379", port=6379, db=0, decode_responses=True)
...
#         print(f"✅ Response in from model {time.time() - start:.2f}s")
#         print(parellal_runnable.invoke(question))
